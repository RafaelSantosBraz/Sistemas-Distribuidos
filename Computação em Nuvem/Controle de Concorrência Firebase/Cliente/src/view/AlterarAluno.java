...
public class AlterarAluno extends javax.swing.JFrame {
    ...
    private void botaoAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAlterarActionPerformed
        try {
            if (Controladora.getInstancia().alterarAluno(Integer.parseInt(campoID.getText()), campoNome.getText(), Integer.parseInt(campoIdade.getText()), campoRA.getText())) {
                JOptionPane.showMessageDialog(jPanel1, "O aluno foi atualizado!", "OK", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(jPanel1, "Aluno não atualizado!", "Erro", JOptionPane.ERROR_MESSAGE);
            }
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(jPanel1, "ID e Idade devem ser números inteiros", "Erro", JOptionPane.ERROR_MESSAGE);
        }
