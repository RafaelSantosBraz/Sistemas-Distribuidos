...
public class MainView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nós Conectados:");
        ...
        jTextArea1.setToolTipText("IP;porta;regname");
        ...
        jLabel4.setText("RegName:");

        jLabel5.setText("Caminho da Pasta:");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        List<Node> connectedNodes = ViewController.getInstance().createNodeList(jTextArea1.getText().split("\\r?\\n"));
        if (connectedNodes == null) {
            JOptionPane.showMessageDialog(null, "Nós conectados inválidos!", "Erro", JOptionPane.ERROR_MESSAGE);
            return;
        }
        int port;
        try {
        ...
        if (!ViewController.getInstance().startService(IP, regName, port, dirPath, connectedNodes)) {
